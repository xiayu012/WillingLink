...
export default function TermsPage() {
  return (
    <main className="mx-auto flex max-w-3xl flex-col gap-4 px-4 py-8 text-sm leading-relaxed">
      ...
      <h2 className="mt-4 text-lg font-semibold">2. Use of Services</h2>
      <p>
      ...
      <h2 className="mt-4 text-lg font-semibold">3. SMS Program</h2>
      <p>
        <strong>Program name:</strong> {PROGRAM_NAME}
      </p>
      <p>
        If you provide your phone number and opt in on our contact form, you
        agree to receive <strong>transactional and informational text
        messages</strong> from {BUSINESS_NAME} ({BRAND_NAME}) related to your
        rental inquiry. These messages may include viewing confirmations,
        landlord contact details, follow-up questions about your housing needs,
        and related customer-care communications.
      </p>
      <p>
        This is not a promotional marketing program. We do not send bulk
        advertising blasts unrelated to your inquiry. Message frequency may
        vary depending on your request and listing activity.
      </p>
      <p>
      ...
      <h2 className="mt-4 text-lg font-semibold">4. No Guarantee of Listings</h2>
      <p>
      ...
      <h2 className="mt-4 text-lg font-semibold">5. Intellectual Property</h2>
      <p>
      ...
      <p>
        The site and services are provided on an &quot;as is&quot; basis. To
        the fullest extent permitted by law, {BUSINESS_NAME} is not liable for
        damages arising from your use of the website, reliance on listing
        information, or interactions with third-party landlords.
      </p>

      <h2 className="mt-4 text-lg font-semibold">7. Governing Law</h2>
      <p>
        These Terms are governed by the laws of the State of California, without
        regard to conflict-of-law principles.
      </p>

      <h2 className="mt-4 text-lg font-semibold">8. Contact</h2>
      <p>
