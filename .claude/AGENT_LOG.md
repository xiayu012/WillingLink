...
### 实测（用户给的 6 个 chatId 的原帖）
    ...
    Case A: roommate → 评论 (ai)     Case D: roommate → 评论 (ai)
    Case B: roommate → 评论 (正则)   Case E: roommate → 评论 (正则)
    Case C: roommate → 评论 (正则)   Case F: review  → 跳过 (ai)
