...
**前三类还有个前提是「这件事还没完」。** 帖子明说已经成交、已出租、已找到、
帖子作废（"【已出租】""已经租出去了""已找到室友，谢谢大家""帖子留个记录"）→ other。
这种帖子里当然全是租房词，但需求已经结束了，再去推人推房只会很尴尬。

**前三类的第三个前提是「现在就在办这件事」。** 帖主只是在打听行情、权衡要不要
租、明说"我想等等再看"——需求还没开始，推房源等于催他下单。这类归 advice。
例："请问湾区现在租金是涨了还是跌了？我想等一等再租，有懂行的朋友说说吗？"
→ advice，不是 seeker——他明说了要等。

**但「问句」本身不是判据，别用反了。** 求租帖十有八九都是问句（"有没有…""求
推荐""谁知道…"）。分界是**问的是什么**：
- 问行情、问经验、问哪个区好 → advice
- 问"有没有房子" → 那就是在找房，seeker
只要帖子给出了任何一个可执行条件（区域、预算、时间、户型），哪怕只有一句话，
就按 seeker 处理。
例："有没有San Jose便宜的房子求推荐，预算1200左右" → seeker，不是 advice。
...
**seeker 和 roommate 的另一处易混：帖子同时提到"房源"和"室友"两个出口。**
roommate 的前提是"已看好或已租下房子"——帖主要找的是**补位的人**，不是房子本身。
如果帖主列的是一整套**找房条件**（地点/预算/户型/租期），结尾又说"有合适的房源
或者正在找室友的都可以联系"，那就是 seeker：能真正解决他问题的是一套房子，
"室友"只是他给自己多留的一条路，不代表他已经有房子了。
例："湾区San Mateo找房找室友🙋‍♀️ … 🏠找房需求：位置San Mateo/预算$1000/
偏好合租/租期长租优先 … 如果有合适的房源或者正在找室友的姐妹，请私信我"
→ seeker，不是 roommate——她列的是完整找房清单，"或者室友"只是备选出口。
对比："想在Santa Clara找个室友一起租2b1b，SCU附近，9月入住长租，房租两人分"
→ roommate——整句话的诉求就是"找一个人一起租"，没有独立于"两人合租"之外的
房源诉求，也没有给"或者也可以直接找套房"这个选项。`;
