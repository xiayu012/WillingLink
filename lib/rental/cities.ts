...
export const CITY_TABLE: CityEntry[] = [
  { re: /圣何塞|圣荷塞|圣荷西|圣何西|San\s*Jose/i, en: "San Jose",  zh: "圣何塞",    neighbors: ["Santa Clara", "Milpitas", "Sunnyvale"] },
  { re: /旧金山|三藩市|三番市|San\s*Francisco/i, en: "San Francisco", zh: "旧金山",  neighbors: ["Daly City", "South San Francisco", "Oakland"] },
  { re: /伯克利|柏克利|柏克莱|Berkeley/i,   en: "Berkeley",       zh: "伯克利",    neighbors: ["Oakland", "Albany", "Emeryville"] },
  { re: /奥克兰|屋仑|Oakland/i,            en: "Oakland",        zh: "奥克兰",    neighbors: ["Berkeley", "Emeryville", "San Leandro"] },
  ...
  { re: /桑尼维尔|森尼韦尔|Sunnyvale/i,    en: "Sunnyvale",      zh: "桑尼维尔",   neighbors: ["Santa Clara", "Mountain View", "Cupertino"] },
  { re: /弗里蒙特|菲利蒙|费利蒙|Fremont/i,  en: "Fremont",        zh: "弗里蒙特",   neighbors: ["Newark", "Union City", "Milpitas"] },
  { re: /圣克拉拉|圣塔克拉拉|Santa\s*Clara/i, en: "Santa Clara", zh: "圣克拉拉",   neighbors: ["Sunnyvale", "San Jose", "Cupertino"] },
  { re: /苗必达|米尔皮塔斯|Milpitas/i,     en: "Milpitas",       zh: "苗必达",    neighbors: ["San Jose", "Fremont", "Santa Clara"] },
  { re: /海沃德|海沃|Hayward/i,           en: "Hayward",        zh: "海沃德",    neighbors: ["Union City", "San Leandro", "Fremont"] },
  { re: /纽瓦克|Newark/i,                 en: "Newark",         zh: "纽瓦克",    neighbors: ["Fremont", "Union City", "Milpitas"] },
  { re: /联合市|Union\s*City/i,           en: "Union City",     zh: "联合市",    neighbors: ["Fremont", "Hayward", "Newark"] },
  { re: /戴利城|Daly\s*City/i,            en: "Daly City",      zh: "戴利城",    neighbors: ["San Francisco", "South San Francisco", "Colma"] },
  { re: /库比蒂诺|库柏蒂诺|Cupertino/i,    en: "Cupertino",      zh: "库比蒂诺",   neighbors: ["Sunnyvale", "Santa Clara", "Saratoga"] },
  { re: /圣马特奥|圣马刁|San\s*Mateo/i,    en: "San Mateo",      zh: "圣马特奥",   neighbors: ["Foster City", "Burlingame", "Redwood City"] },
