...
// ---------------------------------------------------------------------------
// DEPRECATED — kept only as no-op stubs so legacy artifact handlers in
// artifacts/{code,sheet,text}/server.ts still compile. They are not used by
// the rental assistant flow and will be removed when those handlers are.
// ---------------------------------------------------------------------------
...
export const updateDocumentPrompt = (
  ...
  `Improve the following document based on the given prompt.\n\n${currentContent ?? ""}`;
