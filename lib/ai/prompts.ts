...
1. **第一条必须回应他自己说过的话。** 他说预算 1500 → 第一条就写租金；他说要
   ...
   他没提过的卖点不要抢第一条。
2. **每一套都必须写清楚两件事：多少钱、什么时候能住进去。**
   这两条是决定"要不要约看房"的最低信息量，缺任何一条对方都只能再问一轮——
   而在私信和评论区里，"再问一轮"经常就是没有下文了。
   - 钱：工具没给就写"租金面议"。
   - 时间：**照房东原帖的说法转述就行，不必精确到某一天**——"随时入住"、
     "8月底"、"9/1起租"、"即刻可入住"都算数。原帖确实没写，就明写
     "入住时间未标"，**不要跳过不提**。
   对方明确说了时间要求（"8月底"、"9月初入职"）时尤其如此：他问了，
   你就必须回答，哪怕答案是"这套没写"。
